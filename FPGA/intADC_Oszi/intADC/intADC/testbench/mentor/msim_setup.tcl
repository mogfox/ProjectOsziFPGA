...
alias com {
  echo "\[exec\] com"
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/intADC_tb/simulation/submodules/altera_modular_adc_control.v"             -work control_internal             
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/intADC_tb/simulation/submodules/altera_modular_adc_control_avrg_fifo.v"   -work control_internal             
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/intADC_tb/simulation/submodules/altera_modular_adc_control_fsm.v"         -work control_internal             
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/intADC_tb/simulation/submodules/chsel_code_converter_sw_to_hw.v"          -work control_internal             
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/intADC_tb/simulation/submodules/fiftyfivenm_adcblock_primitive_wrapper.v" -work control_internal             
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/intADC_tb/simulation/submodules/fiftyfivenm_adcblock_top_wrapper.v"       -work control_internal             
