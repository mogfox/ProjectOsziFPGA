...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/intADC_tb/simulation/submodules/altera_modular_adc_control.v"             -work control_internal             
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/intADC_tb/simulation/submodules/altera_modular_adc_control_avrg_fifo.v"   -work control_internal             
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/intADC_tb/simulation/submodules/altera_modular_adc_control_fsm.v"         -work control_internal             
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/intADC_tb/simulation/submodules/chsel_code_converter_sw_to_hw.v"          -work control_internal             
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/intADC_tb/simulation/submodules/fiftyfivenm_adcblock_primitive_wrapper.v" -work control_internal             
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/intADC_tb/simulation/submodules/fiftyfivenm_adcblock_top_wrapper.v"       -work control_internal             
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/intADC_tb/simulation/submodules/intADC_modular_adc_0.vhd"                 -work modular_adc_0                
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/intADC_tb/simulation/submodules/altera_avalon_reset_source.vhd"           -work intADC_inst_reset_sink_bfm   
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/intADC_tb/simulation/submodules/altera_avalon_clock_source.vhd"           -work intADC_inst_adc_pll_clock_bfm
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/intADC_tb/simulation/submodules/intADC.vhd"                               -work intADC_inst                  
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/intADC_tb/simulation/intADC_tb.vhd"                                                                          
fi
