...
# ACDS 20.1 711 win32 2021.02.25.14:08:51
# ----------------------------------------
...
# ----------------------------------------
# If intADC_tb is one of several IP cores in your
...
ensure_lib                               ./libraries/intADC_inst_reset_sink_bfm   
vmap       intADC_inst_reset_sink_bfm    ./libraries/intADC_inst_reset_sink_bfm   
ensure_lib                               ./libraries/intADC_inst_adc_pll_clock_bfm
vmap       intADC_inst_adc_pll_clock_bfm ./libraries/intADC_inst_adc_pll_clock_bfm
ensure_lib                               ./libraries/intADC_inst                  
vmap       intADC_inst                   ./libraries/intADC_inst                  
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/intADC_tb/simulation/submodules/altera_modular_adc_control.v"             -work control_internal             
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/intADC_tb/simulation/submodules/altera_modular_adc_control_avrg_fifo.v"   -work control_internal             
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/intADC_tb/simulation/submodules/altera_modular_adc_control_fsm.v"         -work control_internal             
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/intADC_tb/simulation/submodules/chsel_code_converter_sw_to_hw.v"          -work control_internal             
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/intADC_tb/simulation/submodules/fiftyfivenm_adcblock_primitive_wrapper.v" -work control_internal             
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/intADC_tb/simulation/submodules/fiftyfivenm_adcblock_top_wrapper.v"       -work control_internal             
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/intADC_tb/simulation/submodules/intADC_modular_adc_0.vhd"                 -work modular_adc_0                
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/intADC_tb/simulation/submodules/altera_avalon_reset_source.vhd"           -work intADC_inst_reset_sink_bfm   
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/intADC_tb/simulation/submodules/altera_avalon_clock_source.vhd"           -work intADC_inst_adc_pll_clock_bfm
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/intADC_tb/simulation/submodules/intADC.vhd"                               -work intADC_inst                  
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/intADC_tb/simulation/intADC_tb.vhd"                                                                          
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim +access +r -t ps $ELAB_OPTIONS -L work -L control_internal -L modular_adc_0 -L intADC_inst_reset_sink_bfm -L intADC_inst_adc_pll_clock_bfm -L intADC_inst -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L fiftyfivenm_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L fiftyfivenm $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -dbg -O2 +access +r -t ps $ELAB_OPTIONS -L work -L control_internal -L modular_adc_0 -L intADC_inst_reset_sink_bfm -L intADC_inst_adc_pll_clock_bfm -L intADC_inst -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L fiftyfivenm_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L fiftyfivenm $TOP_LEVEL_NAME
}
